...
<body>
    ...
    <div class="current-time">
        ...
        <span id="current-time">2025-05-06 17:58:34</span>
    </div>
...
<div class="chat-widget" id="chatWidget">
    ...
    <div class="chat-body" id="chatBody">
        <div class="chat-messages" id="chatMessages">
            ...
            <div class="chat-loading" style="display: none;" id="typingIndicator">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-2 mb-4" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <a href="findProperties1.jsp" class="footer-link">Properties</a>
                    <a href="findProperties.jsp" class="footer-link">Agents</a>
                ...
                <div class="col-md-3 mb-4" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <a href="#" class="footer-link"><i class="fas fa-map-marker-alt me-2"></i>33/02,Brahammanagama,Panniptiya</a>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            async function handleUserMessage() {
                ...
                if (message) {
                    ...
                    try {
                        // Call the servlet to get AI response
                        const response = await callChatbotServlet(message);
            ...
            // Call the servlet to get AI response
            async function callChatbotServlet(message) {
                try {
                    ...
                    console.error('Error calling chatbot servlet:', error);
                    throw error;
                }
            }

            // Get default response in case of API error
